...
class FollowupMaterializer:
    ...
    def materialize(
        ...
        *,
        ...
        existing_forks = {
            (event.thread_id, child_id)
            for event in events
            if event.event_type == "THREAD_FORKED" and event.thread_id is not None
        ...
        for request in selected:
            ...
            if child_id not in created_threads:
