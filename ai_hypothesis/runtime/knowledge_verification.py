...
from .knowledge import KnowledgeRecord, KnowledgeSnapshot, KnowledgeStateProjector, KnowledgeStatus
...
class KnowledgeVerificationTracker:
    ...
    def pending_delta_ids(
        ...
        *,
        ...
        return tuple(
            record.delta_id
            for record in self.overview().pending_for(thread_id, limit=limit)
        )
