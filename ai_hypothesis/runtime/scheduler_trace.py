...
class TracingSchedulerV0(SchedulerV0):
    ...
    The scheduler policy remains ordinary Scheduler v0. Tracing is observational:
    it records the chosen thread/action/purpose/width/reasons/projection revision in
    the Research Ledger without changing the decision contract.
    """
